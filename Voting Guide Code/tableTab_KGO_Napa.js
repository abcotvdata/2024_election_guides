$(document).ready(function() {
    ...
    $('#nav-us-senate-tab').click(function() {
     ...
     $('#nav-us-house-tab').click(function() {
        loadCSV('Excel_Files/KGO_Napa_Races/US_House_Races.csv', '#nav-us-house-table', updateImagesUSHouse);
    });
    // Load CA Senate Race data
    $('#nav-ca-senate-tab').click(function() {
      loadCSV('Excel_Files/KGO_Napa_Races/CA_Senate_Race.csv', '#nav-ca-senate-table', updateImagesCASenate);
  });
   // Load CA Assembly Race data
   $('#nav-ca-assembly-tab').click(function() {
    loadCSV('Excel_Files/KGO_Napa_Races/CA_Assembly_Race.csv', '#nav-ca-assembly-table', updateImagesCAAssembly);
});
  // Load American Canyon Race data
  $('#nav-am-can-mayor-tab').click(function() {
    loadCSV('Excel_Files/KGO_Napa_Races/American_Canyon_Races.csv', '#nav-am-can-mayor-table');
});

  // Load Napa Race data
  $('#nav-napa-mayor-tab').click(function() {
    loadCSV('Excel_Files/KGO_Napa_Races/Napa_Races.csv', '#nav-napa-mayor-table');
});

  // Load St Helena data
  $('#nav-st-helena-mayor-tab').click(function() {
    loadCSV('Excel_Files/KGO_Napa_Races/St_Helena_Races.csv', '#nav-st-helena-mayor-table');
});
