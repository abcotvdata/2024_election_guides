$(document).ready(function() {
    ...
    $('#nav-us-senate-tab').click(function() {
     ...
     $('#nav-us-house-tab').click(function() {
        loadCSV('Excel_Files/KGO_CC_Races/US_House_Races.csv', '#nav-us-house-table', updateImagesUSHouse);
    });
  ...
  $('#nav-sup-dist-5-tab').click(function() {
    loadCSV('Excel_Files/KGO_CC_Races/CCC_Supervisor_Race.csv', '#nav-sup-dist-5-table');
});

  // Load Antioch Race data
  $('#nav-antioch-mayor-tab').click(function() {
    loadCSV('Excel_Files/KGO_CC_Races/Antioch_Race.csv', '#nav-antioch-mayor-table');
});

  // Load Brentwood data
  $('#nav-brentwood-mayor-tab').click(function() {
    loadCSV('Excel_Files/KGO_CC_Races/Brentwood_Race.csv', '#nav-brentwood-mayor-table');
});

// Load San Ramon data
$('#nav-san-ramon-mayor-tab').click(function() {
  loadCSV('Excel_Files/KGO_CC_Races/San_Ramon_Race.csv', '#nav-san-ramon-mayor-table');
});
