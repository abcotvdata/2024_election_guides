$(document).ready(function() {
  ...
  $('#nav-us-senate-tab').click(function() {
   ...
   $('#nav-us-house-tab').click(function() {
      loadCSV('Excel_Files/KABC_Races/US_House_Races1.csv', '#nav-us-house-table', updateImagesUSHouse);
  });
     // Load LA DA Race data
     $('#nav-la-da-tab').click(function() {
      loadCSV('Excel_Files/KABC_Races/LA_DA.csv', '#nav-la-da-table', updateImagesLADA);
  });

       // Load LA City Council Race data
       $('#nav-la-council-tab').click(function() {
        loadCSV('Excel_Files/KABC_Races/LA_City_Council.csv', '#nav-la-council-table', updateImagesLACC);
    });
...
function updateImagesLACC() {
  $('#nav-la-council tr').each(function() {
      if ($(this).index() === 0) return; // Skip header
      updatePartyImage($(this));
  });
}
