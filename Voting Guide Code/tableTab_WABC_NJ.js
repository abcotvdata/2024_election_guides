$(document).ready(function() {
  ...
  // Load US President Race data
      loadCSV('Excel_Files/WABC_NJ_Races/Presidential_Election_race.csv', '#nav-us-president-table', updateImagesPresident);

  // Load US Senate Race data
  $('#nav-us-senate-tab').click(function() {
      loadCSV('Excel_Files/WABC_NJ_Races/US_Senate_Race.csv', '#nav-us-senate-table', updateImagesUSSenate);
  });
   // Load US House Race data
   $('#nav-us-house-tab').click(function() {
      loadCSV('Excel_Files/WABC_NJ_Races/US_House_Race.csv', '#nav-us-house-table', updateImagesUSHouse);
  });
