$(document).ready(function() {
    ...
    $('#nav-us-senate-tab').click(function() {
     ...
     $('#nav-us-house-tab').click(function() {
        loadCSV('Excel_Files/KGO_Solano_Races/US_House_Races.csv', '#nav-us-house-table', updateImagesUSHouse);
    });
    // Load CA Senate Race data
    $('#nav-ca-senate-tab').click(function() {
      loadCSV('Excel_Files/KGO_Solano_Races/CA_Senate_Race.csv', '#nav-ca-senate-table', updateImagesCASenate);
  });
   // Load CA Assembly Race data
   $('#nav-ca-assembly-tab').click(function() {
    loadCSV('Excel_Files/KGO_Solano_Races/CA_Assembly_Race.csv', '#nav-ca-assembly-table', updateImagesCAAssembly);
});
  // Load Benicia Race data
  $('#nav-benicia-tab').click(function() {
    loadCSV('Excel_Files/KGO_Solano_Races/Benicia_Races.csv', '#nav-benicia-table');
});

  // Load Dixon Race data
  $('#nav-dixon-tab').click(function() {
    loadCSV('Excel_Files/KGO_Solano_Races/Dixon_Races.csv', '#nav-dixon-table');
});

  // Load Rio Vista data
  $('#nav-rio-vista-tab').click(function() {
    loadCSV('Excel_Files/KGO_Solano_Races/Rio_Vista_Races.csv', '#nav-rio-vista-table');
});

 // Load Vallejo Race data
 $('#nav-vallejo-tab').click(function() {
  loadCSV('Excel_Files/KGO_Solano_Races/Vallejo_Races.csv', '#nav-vallejo-table');
});
