$(document).ready(function() {
    ...
    $('#nav-us-senate-tab').click(function() {
     ...
     $('#nav-us-house-tab').click(function() {
        loadCSV('Excel_Files/KGO_Sonoma_Races/US_House_Races.csv', '#nav-us-house-table', updateImagesUSHouse);
    });
    // Load CA Senate Race data
    $('#nav-ca-senate-tab').click(function() {
      loadCSV('Excel_Files/KGO_Sonoma_Races/CA_Senate_Race.csv', '#nav-ca-senate-table', updateImagesCASenate);
  });
   // Load CA Assembly Race data
   $('#nav-ca-assembly-tab').click(function() {
    loadCSV('Excel_Files/KGO_Sonoma_Races/CA_Assembly_Race.csv', '#nav-ca-assembly-table', updateImagesCAAssembly);
});
  // Load Petaluma Race data
  $('#nav-petaluma-tab').click(function() {
    loadCSV('Excel_Files/KGO_Sonoma_Races/Petaluma_Races.csv', '#nav-petaluma-table');
});

  // Load Santa Rosa Race data
  $('#nav-sr-tab').click(function() {
    loadCSV('Excel_Files/KGO_Sonoma_Races/Santa_Rosa_Races.csv', '#nav-sr-table');
});
