$(document).ready(function() {
  ...
  // Load Marin Race data
  $('#nav-sup-dist-2-tab').click(function() {
    loadCSV('Excel_Files/KGO_Napa_Races/American_Canyon_Races.csv', '#nav-sup-dist-2-table');
});

  // Load San Rafael Race data
  $('#nav-san-rafael-mayor-tab').click(function() {
    loadCSV('Excel_Files/KGO_Napa_Races/Napa_Races.csv', '#nav-san-rafael-mayor-table');
});
